...
Project.modules.breeds_management = {
    init: function() {
    ...
    validate: function (){
        ...
        $("#frmaddupdate").validate({
            ...
            messages : {
            "i_breeds_name": {
                "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.BREEDS_MANAGEMENT_NAME)
            },
            "i_breeds_image": {
                "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.BREEDS_MANAGEMENT_IMAGE)
            },
            "i_breeds_status": {
                "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.BREEDS_MANAGEMENT_STATUS)
            }
        },
    ...
    initEvents: function(elem){
                ...
                $('#upload_drop_zone_i_breeds_image').width($('#uploadify_i_breeds_image').width() + 18);
                $('#uploadify_i_breeds_image').fileupload({
                    url : el_form_settings.upload_form_file_url, 
                    name : 'i_breeds_image', 
                    temp : 'temp_i_breeds_imagee', 
                    paramName : 'Filedata', 
                    maxFileSize : '102400', 
                    acceptFileTypes : 'gif|png|jpg|jpeg|jpe|bmp|ico',
                    dropZone: $('#upload_drop_zone_i_interests_image, #upload_drop_zone_i_breeds_image + .upload-src-zone'),
                    formData: {
                        'unique_name' : 'i_breeds_image', 
                        'id' : $('#id').val(),
                        'type' : 'uploadify'
                    },
                    add: function(e, data) {
...
Project.modules.breeds_management.init();
