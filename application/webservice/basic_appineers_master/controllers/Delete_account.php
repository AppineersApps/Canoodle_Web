...
class Delete_account extends Cit_Controller
{
    ...
    public function start_delete_account($request_arr = array(), $inner_api = FALSE)
    {
        try
        {
            ...
            {
            $input_params = $this->delete_relation_tables($input_params,'user_media');
            $condition_res = $this->is_deleted($input_params);
            if ($condition_res["success"])
            {
                $input_params = $this->delete_relation_tables($input_params,'user_breed');
                $condition_res = $this->is_deleted($input_params);
                if ($condition_res["success"])
                {
                    $input_params = $this->delete_relation_tables($input_params,'user_connections');
                    $condition_res = $this->is_deleted($input_params);
                    if ($condition_res["success"])
                    {
