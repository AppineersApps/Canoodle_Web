...
class User_list extends Cit_Controller
{
    ...
    public function get_posted_details_v1($input_params = array())
    {
        ...
        try
        {
            ...
            $this->block_result = $this->User_list_model->get_posted_details_v1($user_id);
    ...
    public function post_videos($input_params = array())
    {
        ...
        try
        {
             ...
             $user_id = isset($input_params["user_id"]) ? $input_params["user_id"] : "";
            $this->block_result = $this->User_list_model->post_video_v1($user_id);
                ...
                if(false == empty($data_arr["media_file"])){
                    ...
                    if(false== empty($arrFile['filename'])){
                      ...
                      if(false == empty($post_media_id)){
                         $arrUpdate= $this->User_list_model->update_thumbnail_image($post_media_id, $arrFile['filename']);
    ...
    public function update_profile($input_params = array())
    {
        ...
        try
        {
            ...
            $this->block_result = $this->User_list_model->set_profile($params_arr);
        }
        catch(Exception $e)
        {
            $success = 0;
   ...
   { 
    ...
    public function get_users_list_details($input_params = array())
    {
        ...
        try
        {
            ...
            if(isset($input_params['search_radius']) && $input_params['search_radius'] != ''){
            ...
            $this->block_result = $this->User_list_model->get_users_list_details($arrParams);
...
//////////////
    ...
    public function get_users_connection_details($user_id = '',$connection_id='',$other_user_id='')
    {
        ...
        try
        {
            ...
            $this->block_result = $this->User_list_model->get_users_connection_details($user_id,$connection_id,$other_user_id);
    ...
    public function get_query_details($media_id = array())
    {
        ...
        try
        {
           ...
           if(is_array($media_id)){
            ...
            $this->block_result = $this->User_list_model->media_images($media_id);
            if (!$this->block_result["success"])
            {
                throw new Exception("No records found.");
            }
      ...
      $this->block_result = array();
        ...
        try
        {
            ...
            foreach($input_params as $value){
                 ...
                 $this->block_result = $this->User_list_model->delete_media($arrResult);
