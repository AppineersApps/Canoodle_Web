    ...
    public function get_notification_details($input_params = array())
    {
        ...
        try
        {
            ...
            if (is_array($result_arr) && count($result_arr) > 0)
            {
                ...
                {
                    $arrConnectionType = $this->get_users_connection_details($user_id,$data_arr["notification_user_id"]);
      ...
      try
        {
            ...
            $input_params = $this->check_notification_exist($input_params);
            if ($input_params["checknotificationtatus"]["status"])
            {
