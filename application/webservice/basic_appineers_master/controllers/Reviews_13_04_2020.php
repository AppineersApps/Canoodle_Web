...
//print_r($input_params); exit;
    ...
    public function set_review($input_params = array())
    {
       // print_r($input_params); exit;
        ...
        $input_params["set_review"] = $this->block_result["data"];
        $input_params = $this->wsresponse->assignSingleRecord($input_params, $this->block_result["data"]);
        return $input_params;
    }
      ...
      try
        {
            ...
            $condition_res = $this->check_review_exist($input_params);
           
            if ($condition_res["checkreviewexist"]["status"])
            {
