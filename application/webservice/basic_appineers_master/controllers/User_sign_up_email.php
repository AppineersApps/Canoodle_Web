...
class User_sign_up_email extends Cit_Controller
{
    ...
    public function start_user_sign_up_email($request_arr = array(), $inner_api = FALSE)
    {
        try
        {
            ...
            if ($condition_res["success"])
            {
                ...
                if($input_params['message'] == 'Extention is not allowed'){
                    $output_response = $this->extention_success_1($input_params);
    ...
    public function create_user($input_params = array())
    {
        ...
        try
        {
            ...
            if (!empty($sent_file))
            {
                ...
                if ($this->general->validateFileFormat($images_arr["user_profile"]["ext"], $_FILES["user_profile"]["name"]))
                {
                    if ($this->general->validateFileSize($images_arr["user_profile"]["size"], $_FILES["user_profile"]["size"]))
                    {
                        ...
                        $images_arr["user_profile"]["name"] = $filename. "_" .uniqid() . "." . $ext;
                    }
                }else{
                   $setting_fields = array(
                    ...
                    $this->block_result["data"] = $setting_fields;
            ...
            if (isset($input_params["age"]))
            {
                $params_arr["age"] = $input_params["age"];
            }
            ...
            {
                $folder_name = "canoodle/user_profile";             
...
/**
     ...
     * @return array $responce_arr returns responce array of api.
     */
    public function extention_success_1($input_params = array())
    {
