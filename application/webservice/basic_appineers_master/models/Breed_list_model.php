...
class Breed_list_model extends CI_Model
{
    /**
    ...
    /**
     * breed_list method is used to execute database queries for States List API.
    ...
    public function breed_list()
    {
        try {
            ...
            $this->db->from("breed");
            $this->db->select('iBreedsId AS business_type_id');
            $this->db->select('vBreedsName AS business_type_name');
