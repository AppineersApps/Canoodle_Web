...
class Users_model extends CI_Model
{
 ...
 /**
    ...
    /**
     * like_count_management method is used to execute database queries for Like User Profile API.
    ...
    public function create_user($params_arr = array())
    {
        try
        {
            ...
            {
                $this->db->set("vGender", $params_arr["gender"]);
            }
            if (isset($params_arr["age"]))
            {
                $this->db->set("iAge", $params_arr["age"]);
            }
