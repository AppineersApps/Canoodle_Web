...
class Wscontroller extends Cit_Controller
{
    ...
    public function WSExecuter($func_arg = '', $id_arg = NULL)
    {
        ...
        //request params
        //$request_arr = $this->WSRequestData($_SERVER['REQUEST_METHOD'], $id_arg);
	$request_arr = $this->WSRequestData($all_methods[$func_name]['method'], $id_arg);
        ...
        $api_allowed_without_access_token = array('social_login','user_login_phone','user_login_email','send_verification_link','check_unique_user','social_sign_up','user_sign_up_phone','user_sign_up_email','user','business_type_list','user_email_confirmation','static_pages','send_sms','reset_password_confirmation','reset_password_phone','get_template_message','forgot_password_phone','reset_password','forgot_password','states_list','get_config_paramaters');
        
        if(true == isset($request_arr['page_name']) && 'home'==$request_arr['page_name'] || 'search'==$request_arr['page_name'])
        {
          array_push($api_allowed_without_access_token,'reviews');  
        }
    ...
    public function WSRequestData($method = 'GET_POST', $id_arg = NULL)
    {
        ...
        $request_arr['method']=$_SERVER['REQUEST_METHOD'];
        return $request_arr;
    }
