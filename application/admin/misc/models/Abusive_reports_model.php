...
class Abusive_reports_model extends CI_Model
{
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        else
        {
            ...
            $this->db->select("ar.iReportedId AS ar_abusive_reports_id");
            $this->db->select("ar.iReportByUserId AS ar_reported_by");
            $this->db->select("ar.iReportedUserId AS ar_reported_on");
            $this->db->select("ar.vReportMessage AS ar_message");
            $this->db->select("ar.dtAddedAt AS ar_added_at");
        }
    ...
    public function getListingData($config_arr = array())
    {
       ...
       /* $strWhere = "ar.iReportByUserId <> NULL AND ar.iReportedUserId <> NULL";
