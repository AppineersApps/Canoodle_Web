...
<!-- <input type="hidden" name="u_age" id="u_age" value="<%$data['u_age']|@htmlentities%>"  class='ignore-valid ' />
<input type="hidden" name="u_description" id="u_description" value="<%$data['u_description']|@htmlentities%>"  class='ignore-valid ' />
<input type="hidden" name="u_gender" id="u_gender" value="<%$data['u_gender']|@htmlentities%>"  class='ignore-valid ' /> -->
...
<div class="form-row row-fluid " id="cc_sh_u_age">
<label class="form-label span3 ">
<%$form_config['u_age']['label_lang']%>
</label>
<div class="form-right-div  <%if $mode eq 'Update'%>frm-elements-div<%/if%> ">
<%if $mode eq "Update"%>
<input type="hidden" class="ignore-valid" name="u_age" id="u_age" value="<%$data['u_age']|@htmlentities%>" />
<span class="frm-data-label">
<strong>
<%if $data['u_age'] neq ""%>
<%$data['u_age']%>
...
<%else%>
<input type="text" placeholder="" value="<%$data['u_age']|@htmlentities%>" name="u_age" id="u_age" title="<%$this->lang->line('USERS_MANAGEMENT_FIRST_NAME')%>"  data-ctrl-type='textbox'  class='frm-size-medium'  />
<%/if%>
</div>
<div class="error-msg-form "><label class='error' id='u_ageErr'></label></div>
</div>

<div class="form-row row-fluid " id="cc_sh_u_description">
<label class="form-label span3 ">
<%$form_config['u_description']['label_lang']%>
</label>
<div class="form-right-div  <%if $mode eq 'Update'%>frm-elements-div<%/if%> ">
<%if $mode eq "Update"%>
<input type="hidden" class="ignore-valid" name="u_description" id="u_description" value="<%$data['u_description']|@htmlentities%>" />
<span class="frm-data-label">
<strong>
<%if $data['u_description'] neq ""%>
<%$data['u_description']%>
<%else%>
<%/if%>
</strong></span>
<%else%>
<input type="text" placeholder="" value="<%$data['u_description']|@htmlentities%>" name="u_description" id="u_description" title="<%$this->lang->line('USERS_MANAGEMENT_FIRST_NAME')%>"  data-ctrl-type='textbox'  class='frm-size-medium'  />
<%/if%>
</div>
<div class="error-msg-form "><label class='error' id='u_descriptionErr'></label></div>
</div>

<div class="form-row row-fluid " id="cc_sh_u_gender">
<label class="form-label span3 ">
<%$form_config['u_gender']['label_lang']%>
</label>
<div class="form-right-div  <%if $mode eq 'Update'%>frm-elements-div<%/if%> ">
<%if $mode eq "Update"%>
<input type="hidden" class="ignore-valid" name="u_gender" id="u_gender" value="<%$data['u_gender']|@htmlentities%>" />
<span class="frm-data-label">
<strong>
<%if $data['u_gender'] neq ""%>
<%$data['u_gender']%>
<%else%>
<%/if%>
</strong></span>
<%else%>
<input type="text" placeholder="" value="<%$data['u_gender']|@htmlentities%>" name="u_gender" id="u_gender" title="<%$this->lang->line('USERS_MANAGEMENT_FIRST_NAME')%>"  data-ctrl-type='textbox'  class='frm-size-medium'  />
<%/if%>
</div>
<div class="error-msg-form "><label class='error' id='u_genderErr'></label></div>
</div>
