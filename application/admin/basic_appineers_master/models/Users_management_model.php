...
class Users_management_model extends CI_Model
{
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        $this->db->select("u.vGender AS u_gender");
        $this->db->select("u.vDescription AS u_description");
        $this->db->select("u.iAge AS u_age");
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array(
                ...
                "file_inline" => "Yes",
                "file_server" => "amazon",
                "file_folder" => "canoodle/user_profile",
                "file_width" => "80",
                "file_height" => "80"
            ),
                "u_first_name" => array(
    ...
    public function getFormConfiguration($name = "")
    {
        $form_config = array(
                ...
                "type" => "textbox",
                "label" => "Age",
                "lang_code" => "USERS_MANAGEMENT_AGE",
                "label_lang" => $this->lang->line('USERS_MANAGEMENT_AGE')
            ),
                "u_description" => array(
                "name" => "u_description",
                "table_name" => "users",
                ...
                "type" => "textbox",
                "label" => "Description",
                "lang_code" => "USERS_MANAGEMENT_DESCRIPTION",
                "label_lang" => $this->lang->line('USERS_MANAGEMENT_DESCRIPTION')
            ),
                "u_gender" => array(
                "name" => "u_gender",
                "table_name" => "users",
                ...
                "type" => "textbox",
                "label" => "Gender",
                "lang_code" => "USERS_MANAGEMENT_GENDER",
                "label_lang" => $this->lang->line('USERS_MANAGEMENT_GENDER')
            ),
        );
