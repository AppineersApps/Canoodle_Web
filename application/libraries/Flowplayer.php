...
public function getThumnails($videoUrl = "", $width = 0, $height = 0, $token = "") {
        ...
        //unlink($command);
        //echo $this->CI->config->item('captcha_temp_path'); exit;
        $temppath = $this->CI->config->item('captcha_temp_path') . $filename;

         $arrFile = array("temppath"=>$temppath,"filename"=>$filename);
