                        ...
                        if (in_array(strtolower(end($image_valid_ext)), $this->CI->config->item('IMAGE_EXTENSION_ARR'))) {
                            if ($is_inline == "Yes") {
                                if ($edit_link == "Yes") {
                                    ...
                                    $buttons_html .= "<a hijacked='yes' title='" . $file_name . "' href='" . $source_url . "' class='fancybox-image form-image-anchor viewer-item-src'><img src='" . $source_url . "' width='" . $img_width . "' height='" . $img_height . "' class='" . $tooltip_class_img . $classes . "' onerror='imageLoadingError(this)' /></a>";
                                }
                            } else {
